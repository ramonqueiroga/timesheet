...
<body>
	<nav class="navbar navbar-fixed-top navbar-light" style="background-color: #222222; color:#FFFFFF;">
  		<div class="container">
	                ...
	                <h1>${textoPagina}</h1>
	                    <form role="form" action="${linkTo[LoginController].autentica(null, null)}" method="post" id="login-form" autocomplete="off">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <input type="text" name="usuario" id="usuario" class="form-control transparent-input" placeholder="Usuário">
	                        </div>
	                        <div class="form-group">
	                            <label for="senha" class="sr-only">Senha</label>
	                            <input type="password" name="senha" id="senha" class="form-control transparent-input" placeholder="Senha">
	                        </div>
	                        <div class="checkbox">
	                            <span class="character-checkbox" onclick="showPassword()"></span>
	                            <span class="label">Mostrar senha</span>
	                        </div>
	                        <input type="submit" id="btn-login" class="btn btn-custom btn-lg btn-block transparent-input" value="Entrar">
	                    </form>
